...
Congratulations on creating a new Stripes UI app module!  Follow the instructions below to run ui-cataloging and start your development.
...
Run the following from the ui-cataloging directory to serve your new app using a development server:
```
stripes serve
```
