...
// function AutoSuggestInd1(props) {
//   const initialState = {
//     tagCodeArray: []
//   };
...
//   const onChange = (ind1Code) => {
//     const { dispatch, change, input } = props;
//     dispatch(change(REDUX.FORM.VARIABLE_FORM, input.name, ind1Code));
//   };
...
// export default injectProps(AutoSuggestInd1);
