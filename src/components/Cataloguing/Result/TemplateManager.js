...
import ActionsMenuButton from '../components/ActionsMenu';
import { Custom006, Custom007, Custom008, CustomLeader } from '..';
    ...
    if (templateById === undefined) {
      ...
      return (
        <AccordionSet>
          ...
          <Accordion header={FilterAccordionHeader} label="Leader" id="leader">
            <Collapsible
              onOpen={() => {
          ...
          <Accordion header={FilterAccordionHeader} label="Control fields" id="control-field">
          ...
          <Accordion
            ...
            id="variable-field"
            displayWhenOpen={<ActionsMenuButton {...this.props} labels={{}} />}
            displayWhenClosed={<ActionsMenuButton {...this.props} labels={{}} />}
          >
            {templateById.fields.map(el => {
