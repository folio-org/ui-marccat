...
export const VIEW_TEMPLATE = `${prefix}VIEW_TEMPLATE`;
export const VIEW_TEMPLATE_SUCCESS = `${prefix}VIEW_TEMPLATE_SUCCESS`;
export const FETCH_VIEW_TEMPLATE = `${prefix}FETCH_VIEW_TEMPLATE`;
export const TEMPLATE_GET_BY_ID = `${prefix}TEMPLATE_GET_BY_ID`;
...
export const LEADER_VALUES_FROM_TAG = `${prefix}LEADER_VALUES_FROM_TAG`;
export const FETCH_LEADER_VALUES_FROM_TAG = `${prefix}FETCH_LEADER_VALUES_FROM_TAG`;
export const LEADER_VALUES_FROM_TAG_SUCCESS = `${prefix}LEADER_VALUES_FROM_TAG_SUCCESS`;
export const FETCH_VALUES_FROM_TAG_008 = `${prefix}FETCH_VALUES_FROM_TAG_008`;
export const VALUES_FROM_TAG_008 = `${prefix}VALUES_FROM_TAG_008`;
export const VALUES_FROM_TAG_008_SUCCESS = `${prefix}VALUES_FROM_TAG_008_SUCCESS`;
export const HEADER_TYPES_008 = `${prefix}HEADER_TYPES_008`;
...
export const CHANGE_008_BY_LEADER = `${prefix}CHANGE_008_BY_LEADER`;
export const CHANGE_008_BY_LEADER_REQUESTED = `${prefix}CHANGE_008_BY_LEADER_REQUESTED`;
export const CHANGE_008_BY_LEADER_SUCCESS = `${prefix}CHANGE_008_BY_LEADER_SUCCESS`;
...
export const ACTION = {
  ...
  VIEW_TEMPLATE,
  VIEW_TEMPLATE_SUCCESS,
  FETCH_VIEW_TEMPLATE,
  TEMPLATE_GET_BY_ID,
  FETCH_TEMPLATE_GET_BY_ID,
  TEMPLATE_GET_BY_ID_SUCCESS,
  LEADER_VALUES_FROM_TAG,
  FETCH_LEADER_VALUES_FROM_TAG,
  LEADER_VALUES_FROM_TAG_SUCCESS,
  VALUES_FROM_TAG_008,
  CLOSE_PANELS,
  CUSTOM_COLUMN_VIEW,
  RECORD_DETAIL,
  ...
  CHANGE_008_BY_LEADER,
  CHANGE_008_BY_LEADER_REQUESTED,
  CHANGE_008_BY_LEADER_SUCCESS,
  TOTAL_BIB_COUNT,
  TOTAL_AUTH_COUNT,
