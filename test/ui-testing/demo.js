...
module.exports.test = (uiTestCtx) => {
  describe('Module test: ui-cataloging:', function() {
    ...
    describe('Login > navigate to app > verify message > logout', () => {
      ...
      it('should open app and see stripes-new-app-greeting', (done) => {
        nightmare
          .wait('#clickable-cataloging-module')
          .click('#clickable-cataloging-module')
          .wait('#cataloging-module-display')
    ...
    describe('Login > navigate to app settings > verify message > logout', () => {
      ...
      it('should open app settings and see stripes-new-app-settings-message', (done) => {
        nightmare
          ...
          .wait('a[href="/settings/cataloging"]')
          .click('a[href="/settings/cataloging"]')
          .wait('a[href="/settings/cataloging/general"]')
          .click('a[href="/settings/cataloging/general"]')
